create table tb_game (id bigint not null auto_increment, plataform integer, title varchar(255), genre_id bigint, primary key (id)) engine=MyISAM;
create table tb_genre (id bigint not null auto_increment, name varchar(255), primary key (id)) engine=MyISAM;
create table tb_record (id bigint not null auto_increment, age integer, moment datetime, name varchar(255), game_id bigint, primary key (id)) engine=MyISAM;
...
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('The Witcher 3', 2, 3);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('League of Legends', 0, 2);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('CS GO', 0, 1);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Cyberpunk 2077', 0, 3);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Cyberpunk 2077', 2, 3);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('God of War', 0, 3);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('God of War', 1, 3);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Overwatch', 0, 1);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Valorant', 0, 1);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Fall Guys', 0, 4);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Fall Guys', 1, 4);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Fortnite', 0, 4);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Dragon Age Inquisition', 2, 3);
INSERT INTO tb_game (title, plataform, genre_id) VALUES ('Dragon Age Inquisition', 1, 3);
